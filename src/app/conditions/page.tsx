...
const Conditions = ({ onClose }: any) => {
  const termsAndConditions = [
    ...
    },
    {
      ...
      content:
        "Cécile Boiron E.I propose des services de gestion administrative, gestion commerciale, gestion du personnel, et pré-comptabilité. Le détail des services proposés est disponible sur le site internet cecileboiron.com.",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      content:
        "Tous les éléments du site internet cecileboiron.com, y compris les textes, images, logos et documents, sont la propriété exclusive du Prestataire, sauf mention contraire. Toute reproduction ou utilisation sans autorisation est strictement interdite.",
    },
    {
      id: 11,
    ...
    },
    {
      ...
      content:
        "Cécile Boiron E.I se réserve le droit de modifier les présentes CGPS à tout moment. Les nouvelles CGPS seront applicables dès leur publication sur le site internet cecileboiron.com.",
    },
    {
      id: 13,
